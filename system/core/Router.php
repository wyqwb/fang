...
class CI_Router {
	 ...
	 * @return	void
	 */
	function _set_request2($segments = array())
	{
		$segments = $this->_validate_request($segments);
	...
	function _validate_request($segments)
	{
		...
		if (is_dir(APPPATH.'controllers/'.$segments[0]))
		{
            ...
            $this->set_module_directory(implode('/', $tempDir));
	...
	function _validate_module_request($segments)
	{
		...
		$this->set_module_directory('../third_party');
	 ...
	 * @return	array
	 */
	function _validate_request2($segments)
	{
		if (count($segments) == 0)
		{
			return $segments;
	 ...
	 * @return	void
	 */
	function set_module_directory($dir)
	{
		$this->directory = $dir.'/';
	}
	// --------------------------------------------------------------------
