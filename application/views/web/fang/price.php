...
<body>
	...
	<!-- 底部 -->
		...
		<div class="g-bd-ft" style="width:980px;height:auto;border:1px solid #ccc;text-align:center">
			...
			<div id="scroll" style="width:980px;height:200px;background-color:#ccc;overflow: hidden;position:relative;font-size:16px;">
...
<!-- 				<div class="jia_fang_item">
				...
				<div class="btn-left2" style="top:80px;left:-10px;background:none;color:#fff"><</div>
				<div class="btn-right2" style="top:80px;right:-10px;background:none;color:#fff">></div>
			</div>
