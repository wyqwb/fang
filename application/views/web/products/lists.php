...
<div id="main">
  ...
  <div class="content fr">
    ...
    <div class="list">
    <ul>
       <?php foreach($newList2['result'] as $item):?>
      <li><a href="./products/content/<?php echo $item['id'];?>"><?php echo $item['title'];?></a><div class="fr"><?php echo $item['published'];?></div></li>
      <?php endforeach;?>
    </ul>
    
    </div> 
     <div class="page">
     	<ul><?php echo $newList2['page'];?></ul>
     </div>
  </div>
 <div class="clear"></div>
</div>
