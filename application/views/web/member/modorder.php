...
<div class="m" id="orderstate">
  <div class="mt">
          <strong>订单号：496891929&nbsp;&nbsp;&nbsp;&nbsp;状态：
          <span class="ftx14"><?php echo $this->config->item($fangtuan['state'])?></span>
          <span id="pay-button-496891929"></span></strong>
          <div class="fr">
          </div>
  </div>
...
<div id="hbdd" class="Tip360" style="width: 600px;">
    ...
    <div class="Tip_Content">
        ...
        <div class="align_Left" style="padding: 15px 0 5px;">请选择要合并到主订单的订单：</div>
        <div id="combin_item">
        </div>
