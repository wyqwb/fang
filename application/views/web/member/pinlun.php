        ...
        <div class="content fr">            
            <!-- 横栏概览 -->
            <div class="userSum"><h2>我的评论列表</h2></div>
            ...
            ?>
                <div class="bd clearfix">
                    <dl class="fl clearfix info">
                        ...
                        <dd class="fl"><a href="/fang/tuandetail/<?php echo $value['id']?>" target="_blank"><?php echo mb_strcut($value['content'], 0, 60, 'utf-8');?></a></dd>
                    </dl>
                    <div class="fl about" style="float:right">
                    <a href="/member/tuan_modify/<?php echo $value['id']?>" >修改</a> 
                    <a href="javascript:void(0)" onclick="deletefangtuan(<?php echo $value['id'] ?>)">删除</a></div>
                </div>
