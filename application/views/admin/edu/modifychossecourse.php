...
<div class="ADD_coninp" style="overflow:hidden;position:absolute;left:0px;top:0px;right:0px;bottom:0px;" id="jsCustomScroll2">
    <form action="<?php echo base_url();?>admin/edu/modifyclasshour" method="post" enctype="multipart/form-data">
        ...
        <input type="hidden" name="id" value="<?php if(isset($classhour['id'])){echo $classhour['id'];}?>" />
        <input type="hidden" name="pid" value="<?php if(isset($classhour['pid'])){echo $classhour['pid'];}?>" />
        <div><label>标题：</label><input type="text" class='js_notnull' data-container="body" data-trigger="focus" data-placement="right" data-content="文章标题不可为空" data-original-title="" name="title" value="<?php if(isset($classhour['title'])){echo $classhour['title'];}?>" /></div>
        <div class="clear "><label>课程类别：</label><input type="text" class='' data-container="body" data-trigger="focus" data-placement="right" data-content="课程类别" data-original-title="" name="category" value="<?php if(isset($classhour['category'])){echo $classhour['category'];}?>" /></div>
        <div class="clear "><label>课程等级：</label><input type="text" class='' data-container="body" data-trigger="focus" data-placement="right" data-content="" data-original-title="" name="level" value="<?php if(isset($classhour['level'])){echo $classhour['level'];}?>" /></div>
        <div class="clear "><label>视频地址：</label><input type="text" class='' data-container="body" data-trigger="focus" data-placement="right" data-content="" data-original-title="" name="video" value="<?php if(isset($classhour['video'])){echo $classhour['video'];}?>" /></div>
        ...
        <div  class="clear"><label>课程描述：</label><div class="Aadd_ueditor"><textarea name="des" id="ueditor" style="width:700px;"><?php if(isset($classhour['des'])){echo $classhour['des'];}?></textarea></div></div>
