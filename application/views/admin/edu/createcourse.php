        ...
        <div class="Aadd_insert">
            ...
            <div class="Aadd_icon">
                ...
                <form action="<?php echo $actUrl;?>" method="post" class='js_needcheck'>
                    ...
                    <div class="clear "><label>课程类别：</label><select name="category"><option value="0">请选择所属分类</option><?php foreach($result as $k=> $v){echo "<option value='".$v['id']."'>".$v['title']."</option>";}?></select></div>
                    ...
                    <div class="clear "><label>课程价格：</label><input type="text" class='' data-container="body" data-trigger="focus" data-placement="right" data-content="" data-original-title="" name="price" value="" /></div>
