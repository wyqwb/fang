                ...
                <div class="Aadd_icon">
                    ...
                    <form action="" method="post" class='js_needcheck' enctype="multipart/form-data">
                        ...
                        <label>分类：</label><?php if(isset($sort)){echo $sort;}?>
                         <input type="hidden"  class='js_notnull' name="type" value="ad" />
                        </div>

                        <div class="clear"><label>排序：</label><input type="text" class='js_notnull' data-container="body" data-trigger="focus" data-placement="right" data-content="广告内容" data-original-title="" name="oid" value="<?php if(isset($result['des'])){echo $result['des'];}?>" /></div>
                        ...
                        <!-- <div  class="clear"><label>内容：</label><div class="Aadd_ueditor"><textarea name="des" id="ueditor" style="width:700px;"><?php if (isset($artcon['content'])) {echo $artcon['content'];}?></textarea></div></div> -->
