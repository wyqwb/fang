            ...
            <div class="Aadd_insert">
                ...
                <div class="Aadd_icon">
                    ...
                    <form action="" method="post" class='js_needcheck' enctype="multipart/form-data">
                        ...
                        <div class="clear"><label>排序：</label><input type="text" class='js_notnull' data-container="body" data-trigger="focus" data-placement="right" data-content="广告排序" data-original-title="" name="oid" value="<?php if(isset($result['oid'])){echo $result['oid'];}?>" /></div>
